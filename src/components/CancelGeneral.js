  ...
  return (
    <div className="cancel-general">
        ...
        <div className="info-box">
          ...
          <div className="info-row">
            ...
            <input
              className="value-box"
              type="text"
              value={bookingData ? new Date(bookingData.start_time).toLocaleString() : ''}
              readOnly
            />
          </div>
          <div className="info-row">
        ...
        <div className="info-box">
          ...
          <div className="info-row">
            ...
            <input
              className="value-box"
              type="text"
              value={bookingData ? `${bookingData.price?.toLocaleString() || '0'}원` : ''}
              readOnly
            />
          </div>
      ...
      <div className="cancel-warning">
        ...
        <ul>
          <li>- 예약 취소는 이용 1시간 전까지 무료로 가능하며, 이후에는 취소 및 환불이 불가능합니다.</li>
          <li>- 결제 수단 및 예약 조건에 따라 환불 처리 기간은 최대 7~14일 소요될 수 있습니다.</li>
          <li>- 취소 후 재예약을 원하실 경우, 다시 예약 절차를 진행해 주셔야 합니다.</li>
          <li>- 부정 예약, 무단 변경, 허위 정보 입력 등은 예약 취소 및 서비스 이용 제한의 사유가 될 수 있습니다.</li>
