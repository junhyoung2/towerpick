  ...
  return (
    <div className="agree-page">
      <div className="agree-title">
        <h1>약관동의</h1>
        <h3>원활한 서비스 제공을 위해<br/>약관 동의가 필요합니다.</h3>
      </div>
      ...
      <div className="terms">
        ...
        <ul>
          ...
          <li>
            ...
            />
            <label htmlFor="agree2" className="icon">이용 약관 동의(필수) <FaChevronDown /></label>
          </li>
          <li>
            <input
              type="checkbox"
            ...
            />
            <label htmlFor="agree3" className="icon">개인정보 수집 및 이용 동의(필수) <FaChevronDown /></label>
          </li>
          <li>
            <input
              type="checkbox"
