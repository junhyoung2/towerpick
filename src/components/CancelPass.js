  ...
  return (
    <div className="cancel-general">
      ...
      <div className="cancel-warning">
        ...
        <ul>
          <li>- 정기권 취소는 이용 시작 1시간 전까지 무료로 가능하며, 이후에는 남은 이용 기간을 기준으로 환불 금액이 산정됩니다.</li>
          <li>- 사용 개시 후 환불 요청 시, 정기권 정가 기준으로 실제 이용 일수를 제외한 금액의 80%만 환불되며, 나머지 20%는 수수료로 공제됩니다.</li>
          <li>- 결제 수단 및 정기권 조건에 따라 환불 처리 기간은 최대 7~14일 소요될 수 있습니다.</li>
